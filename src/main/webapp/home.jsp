...
<body>
    ...
    <nav class="navbar">
        <div class="nav-container">
            <div class="logo">
           <a href="#" style="text-decoration: none;color:inherit;"> <h1 >ManeeshFoods</h1> </a>
            ...
            <div class="nav-links">
                ...
                <form action="user/*" method="post" class="login-btn" style="display: inline;">
            ...
            <a href="menu?restaurantId=<%=r.getRestaurantId()%>"  style="text-decoration: none;color:inherit; ">
             ...
             <div class="restaurant-card">
                    ...
                    <div class="card-content">
                        ...
                        <p class="location"><%=r.getRestaurantAddress() %></p>
                        <div class="cuisine">
