...
<head>
    ...
    <title>Login - ManeeshFoods</title>
    ...
    <div class="main-container">
        ...
        <div class="auth-container">
            <div class="auth-box">
                ...
                <% } %>
                <form action="${pageContext.request.contextPath}/user/login" method="post" class="auth-form">
                ...
                <p class="auth-switch" style="margin-top: 0.5rem;">
                    <a href="${pageContext.request.contextPath}/forgetPassword.jsp">Forgot Password?</a>
                </p>
            </div>
        </div>
    </div>
